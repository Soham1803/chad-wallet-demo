    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      ...
      <div className="relative w-full max-w-[380px] p-8 rounded-3xl bg-dark-panel/40 border backdrop-blur-md border-brand-green/20 shadow-[inset_0_0_24px_rgba(13,242,148,0.35),inset_0_0_2px_rgba(13,242,148,0.5),0_0_30px_rgba(13,242,148,0.15)] flex flex-col items-center z-10 animate-in zoom-in-95 duration-200">
        ...
        {step === "email" ? (
          <div className="w-full space-y-4">
            ...
            <div className="w-full flex items-center justify-center gap-3 my-4">
              ...
              <span className="text-[10px] text-foreground/30 font-semibold uppercase">
                or
              </span>
              <div className="flex-1 h-px bg-dark-border" />
            </div>
            ...
            >
              <svg
                className="w-4.5 h-4.5 mr-2.5 absolute left-5"
                viewBox="0 0 24 24"
                fill="none"
          ...
          <form onSubmit={handleOtpSubmit} className="w-full space-y-4">
            <div className="text-center mb-1">
              ...
              <div className="text-xs font-bold text-white mt-0.5">{email}</div>
            </div>
        ...
        <div className="text-[10px] text-foreground/35 text-center mt-8 leading-relaxed px-1 select-none">
          ...
          <a href="#" className="underline hover:text-foreground/50">
            Terms of Service
          </a>{" "}
          and{" "}
          <a href="#" className="underline hover:text-foreground/50">
...
export default function PrivyProviderWrapper({
  ...
  const appId =
    process.env.NEXT_PUBLIC_PRIVY_APP_ID || "clpigg5p600e0la08hu7849cc";

  // Run mock mode if app id is the default sandbox one or empty
  const isMock =
    appId === "clpigg5p600e0la08hu7849cc" || !appId || appId.includes("xxxx");
