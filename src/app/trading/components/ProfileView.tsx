...
export default function ProfileView({ cashBalance }: TProfileViewProps) {
  return (
    <div className="flex-1 h-full flex flex-col bg-background overflow-y-auto p-4 gap-4 scrollbar-none font-mono text-gray-300 border-r border-[#161b26]/80 animate-fade-in">
      {/* Hero Banner Area */}
